...
const enUS: Record<string, string> = {
  ...
  "bots.setup.guide.feishu.create.2":
    "Copy the App ID and App Secret, then enable persistent connection events for \x60im.message.receive_v1\x60 and card actions.",
  ...
  "bots.setup.guide.webhook.bind.1":
    "POST a private-message callback to ZCode's \x60/api/bots/webhook\x60 endpoint.",
  "bots.setup.guide.webhook.bind.3":
    "If the bot uses a secret, also send \x60x-zcode-bot-secret\x60; then return here after the bind succeeds.",
  ...
  "bots.setup.guide.weixin.create.3":
    "ZCode uses a built-in iLink client: \x60/ilink/bot/getupdates\x60 for long polling and \x60/ilink/bot/sendmessage\x60 for replies.",
